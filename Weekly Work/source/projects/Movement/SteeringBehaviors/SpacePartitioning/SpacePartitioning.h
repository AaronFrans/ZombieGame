...
public:
	...
	void RenderCells(float queryRadius, SteeringAgent* pDebougAgent) const;
...
private:
	...
	int PositionToColIndex(const Elite::Vector2 pos) const;
	int PositionToRowIndex(const Elite::Vector2 pos) const;
